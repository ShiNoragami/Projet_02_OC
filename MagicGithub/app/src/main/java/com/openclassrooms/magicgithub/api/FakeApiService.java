...
public class FakeApiService implements ApiService {
    ...
    public List<User> getUsers() {
        //retourne la liste des utilisateurs à l'ApiService
        return users;
    }
    ...
    public void generateRandomUser() {
        //Rajoute un utilisateur de façon aléatoire a la liste users via l'ApiService
    ...
    public void deleteUser(User user) {
        // Permet de supprimer un utilisateur via l'ApiService
        users.remove(user);
    }
}
